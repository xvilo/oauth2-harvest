...
use Omines\OAuth2\Client\Provider\Exception\harvestIdentityProviderException;
...
class harvest extends AbstractProvider
{
    ...
    /** @var string */
    public $domain = 'https://harvest.com';
    ...
    /**
     * Get the default scopes used by Harvest.
    ...
    /**
     * Harvest uses a space to separate scopes.
     */
    ...
    {
        $user = new harvestResourceOwner($response, $token);
