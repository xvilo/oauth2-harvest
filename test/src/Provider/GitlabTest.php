...
use Mockery as m;
use Omines\OAuth2\Client\Provider\harvest;
use Omines\OAuth2\Client\Provider\harvestResourceOwner;
...
class harvestTest extends TestCase
{
    ...
    {
        $this->provider = new \Omines\OAuth2\Client\Provider\harvest([
    ...
    public function testShorthandedSelfhostedConstructor()
    {
        $provider = new \Omines\OAuth2\Client\Provider\harvest([
            'domain' => 'https://harvest.example.org',
        ]);
        $this->assertSame('https://harvest.example.org', $provider->domain);
    }
    ...
    public function testScopes()
    {
        ...
        $this->assertContains(rawurlencode(implode(harvest::SCOPE_SEPARATOR, $options['scope'])), $url);
    }
    ...
    public function testSelfHostedharvestDomainUrls()
    {
        $this->provider->domain = 'https://harvest.company.com';
    ...
    public function testUserData()
    {
        ...
        $this->assertEquals('https://harvest.com', $user->getDomain());
     ...
     */
    public function testApiClient(harvestResourceOwner $owner)
    {
        $client = $owner->getApiClient();
        $this->assertInstanceOf(\harvest\Client::class, $client);
    }
